(function () {
  ...
  var TOOLS = [
    ...
    { slug: "unit-converter", title: "Unit Converter", category: "data-converters", description: "Convert length, weight and temperature between common units.", keywords: ["unit","converter","length","weight","temperature","metric","imperial"], related: ["timestamp-converter","binary-converter"], priority: 0.8, featured: true },
    ...
    { slug: "qr-code", title: "QR Code Generator", category: "generators", description: "Generate QR codes for any URL or text. Choose size, colors, error correction. Download PNG or SVG.", keywords: ["qr","code","generator","scan","barcode","url","png","svg","download"], related: ["base64","url-encoder"], priority: 0.9, featured: true },
    { slug: "cron-expression-generator", title: "Cron Expression Generator", category: "generators", description: "Build cron expressions from dropdowns. See the next 5 run times before you commit.", keywords: ["cron","expression","generator","schedule","linux","timer","job"], related: ["timestamp-converter","hash-generator"], priority: 0.9, featured: true },
    { slug: "hmac-generator", title: "HMAC Generator", category: "security-tools", description: "Generate HMAC-SHA256 and HMAC-SHA512 signatures from a message and secret key.", keywords: ["hmac","sha256","sha512","signature","authentication","api","webhook","security"], related: ["hash-generator","jwt-decoder"], priority: 0.9, featured: true },
