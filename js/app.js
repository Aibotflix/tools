...
{ slug: "protobuf-decoder", title: "Protobuf Decoder", category: "code-formatters", description: "Decode protobuf binary data into a readable tree. Paste hex or base64 — auto-detects format.", keywords: ["protobuf","decoder","protocol","buffers","grpc","binary","wire","format"], related: ["jwt-decoder","base64"], priority: 0.9, featured: false },
    ...
    { slug: "ai-prompt-cost-calculator", title: "AI Prompt Cost Calculator", category: "ai-prompting", description: "Estimate the dollar cost of a prompt across GPT-5.6, Claude Opus 5, Sonnet 5, Fable 5 and Kimi K3.", keywords: ["ai","cost","calculator","gpt","claude","kimi","tokens","pricing","budget"], related: ["token-counter","codebase-context-packer"], priority: 0.9, featured: false }
  ];
